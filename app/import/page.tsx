      ...
      <div style={containerStyle}>
        ...
        <div style={cardsContainerStyle}>
          ...
          <div style={{ position: "relative" }}>
            <OptionCard emoji="⬆️" title="Upload a File" onClick={() => document.getElementById("file-input")?.click()} />
            <input
              id="file-input"
              type="file"
              accept=".txt,.md"
          ...
          <OptionCard emoji="🍳" title="Choose from Library" onClick={() => router.push("/library")} />
        </div>
